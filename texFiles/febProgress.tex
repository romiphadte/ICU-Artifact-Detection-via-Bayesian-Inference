...
\title{Recreation of Results for Arterial Blood Pressure Estimation Using Particle Filtering} % For titles, only capitalize the first letter
...
\author{Claire Asselstine\affil{1}{University of California},
Romi Phadte\affil{1}{}
\and
Sammy Sidhu\affil{1}{}}
...
\keywords{ICP | Particle Filter | } % When adding keywords, separate each term with a straight line: |
...
% \abbreviations{}
\abbreviations{ICP, intercraneal ; ABP, arterial blood pressure}
